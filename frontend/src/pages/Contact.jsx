  ...
  return (
    <div>
      ...
      <div className='text-center pt-10'>
        <h1 className='text-3xl md:text-4xl font-bold text-gray-800 mb-4'>We’re Always Here for You</h1>
        <p className='text-gray-600 text-lg leading-relaxed max-w-3xl mx-auto'>Whether you’re booking your next stay or need help managing an existing reservation, our friendly support team is just a message away.</p>
      </div>
