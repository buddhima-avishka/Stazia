...
function PropertyType() {
  return (
    <div className='flex flex-col pt-5' id='property'>
      ...
      <p className='text-sm md:text-base text-gray pb-5'>you can easily browse and filter your search by property type. This <br /> feature allows you to select hotels or alternative options, such as hostels, <br /> vacation rentals, or bed and breakfasts, based on your preferences and <br /> specific needs for your stay.</p>
